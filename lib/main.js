...
const {compress, escape, unescape} = require("./utils.js");
...
class LanguageRegExp{
	...
	activate(){
		...
		this.registerCommand("copy-compressed", () => this.copyCompressed());
		this.registerCommand("cut-compressed",  () => this.copyCompressed(true));
		this.registerCommand("copy-escaped",    () => this.copyEscaped());
		this.registerCommand("cut-escaped",     () => this.copyEscaped(true));
		this.registerCommand("paste-unescaped", () => this.pasteUnescaped());
	}
